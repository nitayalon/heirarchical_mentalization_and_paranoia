...
ggsave("../figures/main_paper/figure_3.png", width = 40, height = 20, units = "cm")  
```
...
pl_dom1_offers / (dom_zero_beliefs_vs_dom_one + dom_one_beliefs_vs_dom_zero) + 
  plot_layout(guides = "collect") + 
  plot_annotation(tag_levels = 'A') & theme(plot.tag = element_text(face = 'bold'))
...
pl_dom1_dom2_offers <- 
  ...
  ggplot(aes(x = trial_number, y = offer)) + 
    ...
    theme(aspect.ratio = dynamics_plot_aspect_ratio) +
    theme(text=element_text(size=25)) + 
    # guides(linetype = "none", alpha = "none", fill = "none")
...
pl_dom1_dom2_offers / (dom_two_beliefs_vs_dom_one + dom_one_beliefs_vs_dom_two) + 
  plot_layout(guides = "collect") + 
  plot_annotation(tag_levels = 'A') & theme(plot.tag = element_text(face = 'bold'))
ggsave("../figures/main_paper/figure_5.png", width = 50, height = 30, units = "cm")
```

### Relative reward distribution
...
ggsave("../figures/main_paper/figure_6.png", width = 50, height = 30, units = "cm")
```
...
time_to_random_sender_identification
ggsave("../figures/main_paper/figure_7.png", width = 50, height = 30, units = "cm")
```
...
dom_two_beliefs_vs_minus_one + all_dyads_reward_ratio  + 
  plot_layout(guides = "collect") + 
  plot_annotation(tag_levels = 'A') & theme(plot.tag = element_text(face = 'bold'))
ggsave("../figures/main_paper/figure_8.png", width = 50, height = 30, units = "cm")
```
