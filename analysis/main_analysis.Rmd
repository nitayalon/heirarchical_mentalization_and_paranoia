...
## Figure 2 - adaptive DoM 

### Game dynamics 

```{r dom minus one vs dom zero, fig.width=12, fig.height=4}
sid = 110
...
pl_domminus1_offers
ggsave("../figures/main_paper/figure_2_A.png", plot=pl_domminus1_offers, width = 45, height = 25, units = "cm")
```

```{r dom one vs dom zero, fig.width=12, fig.height=4}
pl_dom1_offers <- 
  first_task_data$game_results %>% 
  filter(receiver_dom_level == 0, 
         sender_dom_level == 1,
...
pl_dom1_offers
ggsave("../figures/main_paper/figure_2_B.png", plot=pl_dom1_offers, width = 45, height = 25, units = "cm")
```

```{r dom one vs dom two, fig.width=12, fig.height=4}
pl_dom1_dom2_offers <- 
  first_task_data$game_results %>% 
  filter(receiver_dom_level == 2, 
         sender_dom_level == 1,
...
pl_dom1_dom2_offers
ggsave("../figures/main_paper/figure_2_C.png", plot=pl_dom1_dom2_offers, width = 45, height = 25, units = "cm")
```
