...
results_path = "~/Max_Planck/Hierarchical-modelling/data/agent_subject/basic_task/softmax/DoM2_receiver_DoM-1_sender_softmax_temp_0.1_rational_sender/"
...
results_path = "~/Max_Planck/Hierarchical-modelling/data/agent_subject/basic_task/softmax/DoM2_receiver_DoM-1_sender_softmax_temp_0.1_random_sender/beliefs/receiver_beliefs/"
...
First analysis - high $\alpha$ leads to lower cumulative reward
...
Interestingly, the $DoM(1)$ learns to pretend to be random to 
manouver the reciever into accepting its offers
...
game_plot <- game_results %>% 
  filter(receiver_dom_level == receiver_dom_level_for_plot, seed == sid) %>% 
