...
typical_offer_sequence %>% 
  ...
  scale_color_manual(values = senders_colours[2:3], 
                     name = (expression(paste("Sender's ",theta))),
                    labels = senders_types[2:3]) + 
  scale_fill_manual(values = senders_colours[2:3], 
                     name = (expression(paste("Sender's ",theta))),
                    labels = senders_types[2:3]) + 
  scale_x_continuous(
      expand = c(0,0),
...
corretct_beliefs <- 
  ...
  scale_color_manual(values = senders_colours, 
                     name = (expression(paste("Sender's ",theta))),
                    labels = senders_types) + 
  scale_fill_manual(values = senders_colours, 
                     name = (expression(paste("Sender's ",theta))),
